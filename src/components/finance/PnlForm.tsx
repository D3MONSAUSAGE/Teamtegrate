...
const PnlForm: React.FC<PnlFormProps> = ({ onSubmit, onCancel }) => {
  ...
  const handleSubmit = (values: FormData) => {
    const newPnl: PnlItem = {
      ...
      data: {
        revenue: {
          foodSales: Number(values.revenue.foodSales),
          beverageSales: Number(values.revenue.beverageSales),
          merchandiseSales: Number(values.revenue.merchandiseSales),
          cateringEvents: Number(values.revenue.cateringEvents),
          otherIncome: Number(values.revenue.otherIncome),
        },
        cogs: {
          foodCosts: Number(values.cogs.foodCosts),
          beverageCosts: Number(values.cogs.beverageCosts),
          merchandiseCosts: Number(values.cogs.merchandiseCosts),
          packagingSupplies: Number(values.cogs.packagingSupplies),
        },
        operatingExpenses: {
          wagesSalaries: Number(values.operatingExpenses.wagesSalaries),
          benefitsPayrollTaxes: Number(values.operatingExpenses.benefitsPayrollTaxes),
          rentLease: Number(values.operatingExpenses.rentLease),
          utilities: Number(values.operatingExpenses.utilities),
          marketingAdvertising: Number(values.operatingExpenses.marketingAdvertising),
          royaltyFees: Number(values.operatingExpenses.royaltyFees),
          advertisingFees: Number(values.operatingExpenses.advertisingFees),
          otherFranchiseFees: Number(values.operatingExpenses.otherFranchiseFees),
          insurance: Number(values.operatingExpenses.insurance),
          maintenanceRepairs: Number(values.operatingExpenses.maintenanceRepairs),
          nonFoodSupplies: Number(values.operatingExpenses.nonFoodSupplies),
          technology: Number(values.operatingExpenses.technology),
          professionalFees: Number(values.operatingExpenses.professionalFees),
          otherOperatingExpenses: Number(values.operatingExpenses.otherOperatingExpenses),
        },
        otherExpenses: {
          depreciationAmortization: Number(values.otherExpenses.depreciationAmortization),
          interestExpense: Number(values.otherExpenses.interestExpense),
          taxes: Number(values.otherExpenses.taxes),
        },
        notes: values.notes,
      },
      createdAt: new Date(),
