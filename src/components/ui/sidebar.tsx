      ...
      return (
        ...
        >
          <SheetContent
            ...
            data-mobile="true"
            className="w-[--sidebar-width] bg-white dark:bg-gray-900 p-0 text-sidebar-foreground [&>button]:hidden border-0 z-50"
            style={
              {
            ...
            side="left"
          >
            <div className="flex h-full w-full flex-col bg-white dark:bg-gray-900">{children}</div>
          </SheetContent>
        </Sheet>
      )
    }
