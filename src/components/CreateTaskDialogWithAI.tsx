...
const CreateTaskDialogWithAI: React.FC<CreateTaskDialogProps> = ({ 
  ...
  const typedProjects: Project[] = projects.map(project => ({
    ...
    createdAt: typeof project.createdAt === 'string' ? project.createdAt : (project.createdAt ? new Date(project.createdAt).toISOString() : new Date().toISOString()),
    updatedAt: typeof project.updatedAt === 'string' ? project.updatedAt : (project.updatedAt ? new Date(project.updatedAt).toISOString() : new Date().toISOString()),
