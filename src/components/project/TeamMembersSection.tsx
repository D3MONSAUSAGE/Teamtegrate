...
import { UseFieldArrayReturn, FieldValues, FieldArrayWithId, UseFormWatch, UseFormSetValue, FieldPath, Path } from 'react-hook-form';
    ...
    <div className="space-y-4">
      ...
      {teamMemberFields.map((field, index) => (
        <div key={field.id} className="flex items-center gap-2">
          <Select
            onValueChange={(value) => {
              setValue(`teamMembers.${index}.memberId` as Path<TFieldValues>, value as any);
            }}
