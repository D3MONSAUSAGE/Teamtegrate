...
export const transformDbProjectToAppProject = (dbProject: any, user?: { organizationId?: string }): Project => {
  return {
    ...
    startDate: dbProject.start_date ? String(dbProject.start_date) : new Date().toISOString(),
    endDate: dbProject.end_date ? String(dbProject.end_date) : new Date().toISOString(),
