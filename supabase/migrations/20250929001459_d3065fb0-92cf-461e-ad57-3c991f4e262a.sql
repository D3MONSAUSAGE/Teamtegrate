-- Add missing columns to inventory_lots table and fix receive_stock function

-- Add missing columns to inventory_lots
ALTER TABLE public.inventory_lots 
ADD COLUMN IF NOT EXISTS vendor_id UUID,
ADD COLUMN IF NOT EXISTS invoice_number TEXT;

-- Update the receive_stock function to use correct column names
