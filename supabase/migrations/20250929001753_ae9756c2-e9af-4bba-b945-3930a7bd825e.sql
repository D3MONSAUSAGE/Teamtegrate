-- Fix ALL missing columns in inventory_transactions table and update receive_stock function

-- Add all missing columns to inventory_transactions table
...
-- Update the receive_stock function to use correct column names and handle all edge cases
...
BEGIN
  ...
  -- Update warehouse_items quantity (handle missing warehouse_id constraint)
  ...
  -- Create inventory transaction record with all required columns
