-- Enhanced RLS policies for meeting security
-- This ensures users only see meetings they're involved in
...
-- Enhanced policies for meeting_participants
...
-- Add organization_id to meeting_participants if it doesn't exist
DO $$ 
BEGIN
  IF NOT EXISTS (
