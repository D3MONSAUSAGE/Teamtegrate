...
DROP POLICY IF EXISTS "mp_insert_organizer_only" ON public.meeting_participants;
DROP POLICY IF EXISTS "mp_update_self_or_organizer" ON public.meeting_participants;
DROP POLICY IF EXISTS "mp_delete_organizer_only" ON public.meeting_participants;
...
DROP POLICY IF EXISTS "mr_select_view_involved" ON public.meeting_requests;
DROP POLICY IF EXISTS "mr_insert_organizer_only" ON public.meeting_requests;
DROP POLICY IF EXISTS "mr_update_organizer_only" ON public.meeting_requests;
DROP POLICY IF EXISTS "mr_delete_organizer_only" ON public.meeting_requests;

-- 4) Create new safe, non-recursive policies
