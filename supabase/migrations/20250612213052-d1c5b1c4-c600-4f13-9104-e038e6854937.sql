...
-- Phase 1: Projects Table RLS Policy Cleanup - Remove ALL conflicting policies and create clean ones

-- Drop ALL existing policies on the projects table (30 total)
...
-- Create 4 clean, simple policies for the projects table
