-- Drop and recreate the can_change_user_role function to include team_leader role support

DROP FUNCTION IF EXISTS public.can_change_user_role(uuid,uuid,text);

-- Create the updated permissions checker to include team_leader role
