-- Fix create_inventory_transaction_from_receipt_line function to use correct transaction_type
...
BEGIN
  ...
  -- Create inventory transaction using 'in' transaction type (not 'receipt')
  INSERT INTO inventory_transactions (
    ...
    'in',  -- Use 'in' instead of 'receipt' to match check constraint
