-- Update functions to accept organization_id as parameter instead of relying on auth context
...
BEGIN
  ...
  FROM public.teams t
  LEFT JOIN public.inventory_items ii ON ii.team_id = t.id AND ii.organization_id = p_organization_id AND ii.is_active = true
