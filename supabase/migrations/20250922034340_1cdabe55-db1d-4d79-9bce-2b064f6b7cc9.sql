-- Add shift linkage, geo, and approvals to time entries (team_id already exists)
...
-- Add indexes for performance (corrected column names)
create index if not exists idx_time_entries_team on public.time_entries (team_id, clock_in);
