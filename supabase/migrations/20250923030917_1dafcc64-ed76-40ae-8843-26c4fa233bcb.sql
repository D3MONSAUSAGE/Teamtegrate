-- PHASE A: Database cleanup and unification (Fixed version)
...
completed_today AS (
  SELECT
    'completed_today'::text AS bucket, 
    t.id::uuid as task_id, 
    t.title, 
    t.status, 
    t.priority, 
